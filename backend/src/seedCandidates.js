...
const clubs = [
    "College Club", "IT Club", "Cultural Club", "Sports Club", "Science Club",
    "Management Club", "Robotics Club", "Literature Club", "Music Club"
];

const positions = [
    { title: "President", count: 6 },
